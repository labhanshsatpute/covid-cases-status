        ...
        <React.Fragment>
            <nav className="navbar navbar-expand fixed-top" style={{display: block}} id="navbar">
                <div className="container card-body">
                    ...
                    <a href="#" className="nav-link ml-auto"data-toggle="tooltip" data-placement="top" title="Tooltip on top"><img src="assets/icons/github.svg" alt="contribute-in-githu"/></a>
                </div>
            </nav>  
        </React.Fragment>
    );
